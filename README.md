NBA Team Performance Analysis – Tableau Dashboard

📌 Project Overview
This project presents an interactive Tableau dashboard built using an NBA dataset to analyze team scoring performance across home and away games.
...
Home vs Away Score Analysis

Interactive Filters for team selection

Clear visual comparisons using bar charts and KPI-style visuals
...
Data Cleaning – Formatting and structuring the dataset
